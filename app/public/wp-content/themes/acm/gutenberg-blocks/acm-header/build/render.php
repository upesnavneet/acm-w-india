...
<nav class="top-bar eyebrow show-for-medium-up" data-topbar data-options="is_hover: false">
	<section class="top-bar-section">
		...
		<?php
		if ( isset( $attributes['topSmall'] ) && $attributes['topSmall'] ) {
			$top_small_menu_array = array(
				'menu'        => $attributes['topSmall'] ?? 2,
				'menu_class'  => 'right',
				'depth'       => 1,
...
<div class="clearfix utilities-area">
	<div class="logo-section">
		<div class="navbar-header show-for-large-up">
			<a class="navbar-brand" href="<?php echo esc_url( get_home_url() ); ?>">
				...
				if ( array_key_exists( 'mediaUrl', $attributes ) ) {
					?>
				<img alt="ACM Logo" height="78" class="logo" title="Home"
					src="
					<?php
																					echo esc_url( $attributes['mediaUrl'] ?? '' );
					?>
																					" />
					<?php
				} else {
				...
				<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" style="margin:0px -7px;"
					...
					<g>
						<g>
							...
							<path fill="#231F20"
								d="M134.396,28.769v1.688h1.578v1.242h-1.578v2.889c0,0.811,0.215,1.215,0.85,1.215    c0.297,0,0.459-0.014,0.648-0.067l0.024,1.255c-0.244,0.096-0.688,0.176-1.203,0.176c-0.618,0-1.116-0.202-1.43-0.539    c-0.365-0.379-0.527-0.986-0.527-1.85V31.7h-0.932v-1.242h0.932v-1.229L134.396,28.769z" />
							<path fill="#231F20"
								d="M137.852,29.512c-0.555,0-0.918-0.405-0.918-0.891c0-0.513,0.377-0.904,0.93-0.904    c0.568,0,0.921,0.392,0.935,0.904c0,0.486-0.36,0.891-0.935,0.891H137.852z M137.027,37.031v-6.575h1.66v6.575H137.027z" />
							<path fill="#231F20"
								d="M143.156,37.18c-1.85,0-3.293-1.27-3.293-3.389c0-2.16,1.416-3.483,3.4-3.483    c1.959,0,3.268,1.377,3.268,3.375c0,2.417-1.701,3.497-3.361,3.497H143.156z M143.211,35.979c0.945,0,1.605-0.918,1.605-2.255    c0-1.026-0.459-2.214-1.592-2.214c-1.179,0-1.648,1.147-1.648,2.241c0,1.269,0.635,2.228,1.621,2.228H143.211z" />
							<path fill="#231F20"
								d="M147.691,32.414c0-0.756-0.025-1.39-0.053-1.958h1.44l0.082,0.986h0.041    c0.297-0.513,1.012-1.134,2.104-1.134c1.146,0,2.336,0.743,2.336,2.822v3.901h-1.662v-3.712c0-0.945-0.351-1.661-1.254-1.661    c-0.662,0-1.121,0.473-1.297,0.972c-0.056,0.135-0.08,0.337-0.08,0.526v3.875h-1.662v-4.617H147.691z" />
							<path fill="#231F20"
								d="M157.992,37.031v-5.333h-0.891v-1.242h0.891v-0.283c0-0.851,0.23-1.701,0.797-2.241    c0.486-0.459,1.148-0.634,1.715-0.634c0.445,0,0.797,0.081,1.053,0.162l-0.104,1.282c-0.188-0.067-0.406-0.122-0.72-0.122    c-0.819,0-1.094,0.688-1.094,1.499v0.337h1.445v1.242h-1.432v5.333H157.992z" />
							<path fill="#231F20"
							<path fill="#231F20"
								d="M199.99,49.21c0.041,1.188,0.973,1.701,2.025,1.701c0.77,0,1.311-0.122,1.819-0.298l0.244,1.135    c-0.565,0.243-1.354,0.418-2.295,0.418c-2.138,0-3.392-1.311-3.392-3.32c0-1.822,1.105-3.537,3.213-3.537    c2.136,0,2.834,1.756,2.834,3.199c0,0.311-0.024,0.555-0.053,0.702H199.99z M202.879,48.049c0.014-0.607-0.256-1.605-1.363-1.605    c-1.022,0-1.457,0.934-1.522,1.605H202.879z" />
							<path fill="#231F20"
								d="M205.58,47.576c0-0.891-0.014-1.539-0.055-2.119h1.432l0.068,1.242h0.039    c0.324-0.92,1.094-1.391,1.809-1.391c0.162,0,0.258,0.012,0.393,0.039V46.9c-0.146-0.026-0.297-0.041-0.5-0.041    c-0.783,0-1.336,0.5-1.481,1.257c-0.027,0.147-0.041,0.323-0.041,0.5v3.415h-1.66L205.58,47.576L205.58,47.576z" />
							<path fill="#231F20"
								d="M211.533,45.457l1.174,3.523c0.137,0.401,0.285,0.901,0.379,1.269h0.041    c0.094-0.364,0.215-0.864,0.35-1.282l1.027-3.51h1.768l-1.646,4.48c-0.903,2.457-1.512,3.552-2.28,4.227    c-0.662,0.566-1.337,0.783-1.742,0.837l-0.377-1.392c0.282-0.066,0.621-0.215,0.957-0.459c0.312-0.201,0.688-0.594,0.918-1.039    c0.057-0.12,0.098-0.215,0.098-0.297c0-0.066-0.016-0.162-0.082-0.323l-2.416-6.034H211.533z" />
						</g>
						<g>

							<linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="1311.9697" y1="395.1787"
								x2="1362.8817" y2="344.2667"
								gradientTransform="matrix(0.7071 0.7071 0.7071 -0.7071 -1161.1237 -644.264)">
							...
							<linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="934" y1="-775.8647"
								x2="934" y2="-734.782" gradientTransform="matrix(1 0 0 -1 -888 -716)">
	...
	<div id="acm-description" class="column large-5 show-for-large-up">
		<div>
			...
			if ( isset( $attributes['text'] ) && $attributes['text'] ) {
				...
				echo esc_html( empty( get_bloginfo( 'description' ) ) ? "We're an international society of educators, scientists, technologists and engineers dedicated to the advancement of computer science and more." : get_bloginfo( 'description' ) );
			}
			?>
	...
	<div id="ctas-and-search" class="column large-5 medium-6 no-pad-left ctas-and-search">
		...
		if ( has_nav_menu( 'secondary' ) ) {
			...
			if ( isset( $attributes['secondary'] ) && $attributes['secondary'] ) {
				$secondary_menu_array = array(
					'menu'        => $attributes['secondary'] ?? 4,
...
<nav class="top-bar main-nav" data-topbar data-options="is_hover: false">
	...
	<section class="top-bar-section">
		...
		if ( isset( $attributes['primary'] ) && $attributes['primary'] ) {
			$primary_menu_array = array(
				'menu'       => $attributes['primary'] ?? 3,
				'menu_class' => 'nav-menu',
